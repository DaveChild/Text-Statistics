...
class TextStatistics
{
    ...
    public function flesch_kincaid_reading_ease($strText)
    {
        ...
        $score = self::bc_calc(206.835, '-', self::bc_calc(self::bc_calc(1.015, '*', $this->average_words_per_sentence($strText)), '-', self::bc-calc(84.6, '*', $this->average_syllables_per_word($strText))), true, 1);
